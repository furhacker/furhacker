...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到FHR！[<a href="<?php echo U('Login/index');?>">登录</a>] [<a href="register.html">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的个人中心</li>
					<!-- <li class="line">|</li>
					<li>客户服务</li> -->
	...
	<!-- <div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="<?php echo C('IMG_URL');?>logo.png" alt="FHR导航"></a></h2>
		</div>
	</div> -->
	<!-- 页面头部 end -->
	...
	<div class="login w990 bc mt10 regist">
		...
		<div class="login_bd">
				...
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="/Home/Reg/captcha" alt="验证码" onclick="this.src='/Home/Reg/captcha/t/'+Math.random()"/>
							<span>看不清？<a href="">换一张</a></span>
						</li>
						<!-- <li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="checkcode" />
							<button value="" id="getCode">免费手机验证码</button>
							<span>看不清？<a href="">换一张</a></span>
						</li> -->
						<li>
							<label for="">&nbsp;</label>
			...
			<div class="mobile fl">
				...
				<p><strong>10086或10010或10000</strong></p>
			</div>
	...
	<!-- <div class="footer w1210 bc mt15">
		...
		<p class="copyright">
			 © 2005-2013 FHR 版权所有，并保留所有权利。  ICP备案证书号:京ICP证xxxxxx号 
		</p>
		<p class="auth">
